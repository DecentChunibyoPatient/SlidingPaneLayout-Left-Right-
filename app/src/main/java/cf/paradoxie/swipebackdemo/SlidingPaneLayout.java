...
public class SlidingPaneLayout extends ViewGroup {
    ...
    final ArrayList<SlidingPaneLayout.DisableLayerRunnable> mPostedRunnables =
            new ArrayList<SlidingPaneLayout.DisableLayerRunnable>();
    ...
    static class SavedState extends AbsSavedState {
        ...
        public static final Creator<SlidingPaneLayout.SavedState> CREATOR = ParcelableCompat.newCreator(
                new ParcelableCompatCreatorCallbacks<SlidingPaneLayout.SavedState>() {
                    @Override
